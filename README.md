...
|---|---|---|
| 🌍 **Interactive Dashboard** | [https://discounted-patrol-bosnia-insights.trycloudflare.com](https://discounted-patrol-bosnia-insights.trycloudflare.com) | Streamlit dashboard — live on AWS EC2 · dark theme · forecast · anomaly detection ⚠️ URL changes on restart — permanent domain coming Week 10 ⚠️ URL changes on restart — permanent domain coming Week 10 |
